...
/* Accelerometer Interrupt (Output) INTx Pin */
#define ACC_INT1_OUT		(1)
#define ACC_INT2_OUT		(2)
...
/* Gyroscope Interrupt (Output) INTx Pin */
#define GYRO_INT3_OUT		(3)
#define GYRO_INT4_OUT		(4)
